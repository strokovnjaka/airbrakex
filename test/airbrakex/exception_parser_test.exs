defmodule Airbrakex.ExceptionParserTest do
  ...
  test "should parse exception" do
    ...
    result = %{
      backtrace: [
        %{file: "(IO) lib/io.ex", function: "inspect(\"test\", [], \"\")", line: 209},
        ...
        %{file: "(ExUnit.Runner) lib/ex_unit/runner.ex", function: "exec_test/1", line: 293}, %{file: "(timer) timer.erl", function: "tc/1", line: 166},
        %{file: "(ExUnit.Runner) lib/ex_unit/runner.ex", function: "-spawn_test/3-fun-1-/3", line: 242}
      ],
